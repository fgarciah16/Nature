...
public class EmpleadosLogin extends javax.swing.JFrame {
 

    public EmpleadosLogin() {
        initComponents();
//        transparenciaButton();
...
//        btn1.setBorderPainted(false);
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/oso-de-peluche (1).png"))); // NOI18N

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/esquema-de-cabeza-de-bebe-con-chupete.png"))); // NOI18N

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/baby-abc-cubes.png"))); // NOI18N
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/Nature.jpg.jpeg"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        PrincipalEmpleado emple = new PrincipalEmpleado();
...
////         */
        try {
            ...
            getLogger(EmpleadosLogin.class.getName()).log(SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        //</editor-fold>
        ...
        invokeLater(() -> {
            new EmpleadosLogin().setVisible(true);
        });
    }
